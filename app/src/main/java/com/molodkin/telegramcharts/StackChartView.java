...
public final class StackChartView extends BaseChart {
    ...
    public void initGraphs() {
        ...
        for (BaseChartGraph graph1 : graphs) {
            ...
            graph.scrollLinePaint.setStrokeWidth(strokeWidth);
        }
    }
    ...
    private void buildLines() {
        ...
        for (int i = 0; i < xPoints.length; i++) {
            ...
            for (BaseChartGraph graph : graphs) {
                ...
                graph.linePoints[k + 1] = top;
                graph.linePoints[k + 2] = i;
                top -= value;
                graph.linePoints[k + 3] = top;
            }
        }
    }
    ...
    private void drawPoints(Canvas canvas) {
        ...
        for (BaseChartGraph graph1 : graphs) {
            StackChartGraph graph = (StackChartGraph) graph1;
            graph.linePaint.setStrokeWidth(strokeWidth);
        }
